...
$req = $bdd->prepare('INSERT INTO article(article_uid, nom, name, img_link) VALUES(:articleUid, :nom, :name, :img0)');
        ...
        if($key=='path'){
          if(substr($value,-9,3)=='img'){
            ...
            if(substr($value, -5)==0) {
              ...
              $req->execute(array( 'articleUid' => $articleUid, 'nom' => $nom, 'name' => $name, 'img0' => $img0));
          }else{
